...
export const ko: I18n = {
  ...
  explorer: {
    ...
    sortNameAsc: "이름 (A→Z)",
    sortNameDesc: "이름 (Z→A)",
    sortCreatedAsc: "만든 날짜 (오래된 순)",
    sortCreatedDesc: "만든 날짜 (최신 순)",
    sortModifiedDesc: "수정한 날짜 (최신 순)",
    sortManual: "수동 (끌어서 순서 변경)",
    sortManualHint: "파일을 다른 파일의 위쪽이나 아래쪽 가장자리로 끌어 놓으면 위치가 바뀝니다. 새 파일은 맨 끝에 추가됩니다.",
    filterAll: '모든 파일',
    filterNoExt: '확장자 없음',
  ...
  settings: {
    ...
    highlightCurrentLineHint: "커서가 있는 줄의 배경에 색을 입힙니다. CodeMirror 편집기에 적용됩니다.",
    ...
    pdfDefaults: {
      ...
      codeThemeDark: '항상 다크',
      frontmatterHint: 'YAML 프런트매터의 `pdf:` 블록으로 문서별 재정의 가능 (pageSize / margin / font / fontSize / footer / toc).',
    },
    ...
    toolbarHidden: "도구 모음 버튼 숨기기(제목 표시줄은 유지)",
    toolbarHiddenHint: "키보드만으로 쓰는 경우에 적합합니다. {key} 또는 명령 팔레트로 다시 표시할 수 있습니다.",
...
,
  ...
  cmd: {
    ...
    view: {
      ...
      toggleToolbar: "보기: 도구 모음 버튼 표시/숨기기",
