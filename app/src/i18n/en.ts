export const en = {
  ...
  explorer: {
    ...
    sortManualHint: "Drag a file onto the top or bottom edge of another to place it. New files go at the end.",
    filterAll: 'All files',
  ...
  settings: {
    ...
    highlightCurrentLineHint: "Tint the background of the line the cursor is on. Applies to the CodeMirror editor.",
    ...
    pdfDefaults: {
      ...
      frontmatterHint: 'Override per document with a `pdf:` block in YAML front matter (pageSize / margin / font / fontSize / footer / toc).',
    },
    ...
    toolbarHidden: "Hide toolbar buttons (keep the title bar)",
    toolbarHiddenHint: "For keyboard-only writing. Bring them back with {key} or the command palette.",
  ...
  cmd: {
    ...
    view: {
      ...
      toggleToolbar: "View: Show / Hide Toolbar Buttons",
