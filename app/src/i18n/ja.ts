...
export const ja: I18n = {
  ...
  explorer: {
    ...
    sortManual: "手動（ドラッグで並べ替え）",
    sortManualHint: "ファイルを別のファイルの上端または下端にドラッグすると位置を変えられます。新しいファイルは末尾に追加されます。",
    filterAll: 'すべてのファイル',
    filterNoExt: '拡張子なし',
  ...
  settings: {
    ...
    highlightCurrentLineHint: "カーソルのある行の背景に色を付けます。CodeMirror エディタに適用されます。",
    ...
    pdfDefaults: {
      ...
      codeThemeDark: '常にダーク',
      frontmatterHint: 'YAML フロントマターの `pdf:` ブロックでドキュメントごとに上書き可能 (pageSize / margin / font / fontSize / footer / toc)。',
    },
    ...
    toolbarHidden: "ツールバーのボタンを隠す（タイトルバーは残す）",
    toolbarHiddenHint: "キーボードだけで書く人向け。{key} またはコマンドパレットで元に戻せます。",
...
,
  ...
  cmd: {
    ...
    view: {
      ...
      toggleToolbar: "表示: ツールバーのボタンを表示/非表示",
