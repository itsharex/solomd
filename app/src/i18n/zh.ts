...
export const zh: I18n = {
  ...
  explorer: {
    ...
    sortModifiedDesc: "修改时间（新→旧）",
    sortManual: "手动（拖动调整顺序）",
    sortManualHint: "把文件拖到另一个文件的上边缘或下边缘即可调整位置；新建的文件排在最后。",
    filterAll: '全部文件',
    filterNoExt: '无扩展名',
  ...
  settings: {
    ...
    highlightCurrentLineHint: "给光标所在行加底色。适用于 CodeMirror 编辑器。",
    codeFontFamily: '代码字体',
    ...
    pdfDefaults: {
      ...
      codeThemeLight: '始终浅色',
      codeThemeDark: '始终深色',
      frontmatterHint: '可在每个文档的 YAML front matter 中以 `pdf:` 块覆盖（pageSize / margin / font / fontSize / footer / toc）。',
    },
    ...
    toolbarHidden: "隐藏工具栏按钮（保留标题栏）",
    toolbarHiddenHint: "适合只用快捷键写作。按 {key} 或在命令面板中即可恢复。",
