...
export const tr: I18n = {
  ...
  explorer: {
    ...
    sortNameAsc: "Ad (A→Z)",
    sortNameDesc: "Ad (Z→A)",
    sortCreatedAsc: "Oluşturma (eskiden yeniye)",
    sortCreatedDesc: "Oluşturma (yeniden eskiye)",
    sortModifiedDesc: "Değiştirme (yeniden eskiye)",
    sortManual: "Elle (sürükleyerek sırala)",
    sortManualHint: "Bir dosyayı başka bir dosyanın üst ya da alt kenarına sürükleyerek yerleştirin. Yeni dosyalar sona eklenir.",
  ...
  settings: {
    ...
    highlightCurrentLineHint: "İmlecin bulunduğu satırın arka planını renklendirir. CodeMirror düzenleyicisi için geçerlidir.",
    ...
    pdfDefaults: {
      ...
      frontmatterHint: 'Belge başına YAML ön bilgisindeki `pdf:` bloğu ile geçersiz kılın (pageSize / margin / font / fontSize / footer / toc).',
    },
    ...
    toolbarHidden: "Araç çubuğu düğmelerini gizle (başlık çubuğu kalsın)",
    toolbarHiddenHint: "Yalnızca klavyeyle yazmak için. {key} ya da komut paletiyle geri getirebilirsiniz.",
...
,
  ...
  cmd: {
    ...
    view: {
      ...
      toggleToolbar: "Görünüm: Araç çubuğu düğmelerini göster / gizle",
